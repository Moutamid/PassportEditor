...
public class AppContext extends Application implements Application.ActivityLifecycleCallbacks,
    ...
    public void onCreate() {
        ...
        activities.add(SplashScreen.class);
        AppOpenAdManager adManager = AppOpenAdManager.get(
                this,
                new Configs(
                        InitialDelay.NONE,
                        getString(R.string.admob_open_id),
    ...
    protected void onMoveToForeground() {
        ...
        if (Stash.getBoolean(Utils.SHOW_AD, true))
...
//        private static final String AD_UNIT_ID = getString(R.string.admob_open_id);
//        private static final String AD_UNIT_ID = "ca-app-pub-3940256099942544/3419835294";
        ...
        public void loadAd(Context context) {
            ...
            AppOpenAd.load(
                    context,
                    context.getResources().getString(R.string.admob_open_id),
//                    AD_UNIT_ID,
                    request,
                    AppOpenAd.APP_OPEN_AD_ORIENTATION_PORTRAIT,
    ...
    private void compress() {
        new Thread(() -> {
            ...
            try {
                ...
                // TODO: ERROR - THIS STASH USAGES ARE ERROR EVERYWHERE
